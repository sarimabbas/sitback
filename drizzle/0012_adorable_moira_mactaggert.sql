...
INSERT INTO `__new_todos`("id", "description", "tag_id", "status", "input_artifacts", "output_artifacts", "work_notes", "priority", "due_date", "created_at", "updated_at") SELECT "id", "description", "tag_id", "status", "input_artifacts", "output_artifacts", "work_notes", "priority", "due_date", "created_at", "updated_at" FROM `todos`;--> statement-breakpoint
